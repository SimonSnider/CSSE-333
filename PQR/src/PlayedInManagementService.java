...
public class PlayedInManagementService {
	...
	int InsertPlayedIn(String AthleteID, String MatchID, String TeamID, String BludgerHits, String PointsScored, String Injuries, String Fouls, String Ejections) {
		try {
	...
	int UpdateCompetedIn(String AthleteID, String MatchID, String TeamID, String BludgerHits, String PointsScored, String Injuries, String Fouls, String Ejections) {
		try {
	...
	int DeleteCompetedIn(String AthleteID, String MatchID, String TeamID) {
		try {
