...
public class PlayedInManagementService {
	...
	int UpdatePlayedIn(String AthleteID, String MatchID, String TeamID, String BludgerHits, String PointsScored, String Injuries, String Fouls, String Ejections) {
		try {
	...
	int DeletePlayedIn(String AthleteID, String MatchID, String TeamID) {
		try {
